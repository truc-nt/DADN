    ...
    return (
        <SafeAreaView className="flex-col h-[100%] w-[100%] bg-lightblue relative px-[8%] pt-[10px] pb-[50px] items-center justify-between">
            ...
            <View className="flex-row justify-center items-center ">
                <TouchableOpacity
                    className="rounded-[50px] bg-white justify-center border-[3px] w-[141px] h-[49px]"
                    onPress={() =>
                        register(setAuth, user, pwd, repwd, io_username, io_key)
                    }
                >
                    <Text
                        style={{ fontFamily: 'LexendSemiBold' }}
                        className="text-[20px] leading-[30px] text-black text-center"
                    >
                        Register
                    </Text>
                </TouchableOpacity>
            ...
            <View className="flex-row justify-center items-center ">
                ...
                <TouchableOpacity onPress={() => navigation.navigate('Login')}>
                    <Text
                        style={{ fontFamily: 'LexendSemiBold' }}
                        className="text-[16px] leading-[16px] text-blue text-center"
                    >
                        Đăng nhập
                    </Text>
                </TouchableOpacity>
