        ...
        <SafeAreaView className="flex-col w-[100%] h-[100%] bg-lightblue relative px-[5%] pb-[70px] items-center">
            <View className="flex-col w-[100%] h-[70%] items-center justify-between">
                ...
                <View className="flex-col w-[80%]">
                    <Text style={{fontFamily: "LexendRegular"}} className="text-[22px] text-center">Đăng ký tài khoản thành công!</Text>
                    <View className="flex-row w-[100%] items-center justify-center">
                        <Text style={{fontFamily: "LexendRegular"}} className="text-[22px]">Đi đến </Text>
                        <TouchableOpacity
                            onPress={() => navigation.navigate("Login")}
                        >
                            <Text style={{fontFamily: "LexendSemiBold"}} className="text-[22px] text-blue">Đăng nhập</Text>
                        </TouchableOpacity>
                    </View>
                </View>
            </View>
